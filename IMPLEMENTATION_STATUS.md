...
- 自动化：typecheck 通过；pack 通过；全量测试 529/529 通过。真实 SillyTavern 尚未验收，R14 保持“未验证”。
...
- 发布边界：本轮只修改 Atlas 仓库，未在用户的 SillyTavern 安装目录执行更新。旧“起点”已有账本的预览式迁移仍需单独实现；不得将 R14 和旧档真实恢复写为已验收。
